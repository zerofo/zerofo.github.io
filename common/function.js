...
function load_binloader() {
    ...
    setTimeout(function(){
    LoadedMSG="发送 bin格式插件(payload) 到端口 9021, <br>请等待 左上角跳窗结束再操作";
...
function load_ftp() {
    ...
    LoadedMSG="FTP 已加载 请等待 左上角跳窗结束再操作";
...
function load_dumper() {
    ...
    LoadedMSG="Dumper 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_linux() {
    ...
    LoadedMSG="Linux 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_app2usb() {
    ...
    LoadedMSG="AppToUSB 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_kerneldump() {
    ...
    LoadedMSG="内核 Dumper 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_todex() {
    ...
    LoadedMSG="toDEX 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_webrte() {
    ...
    LoadedMSG="WebRTE 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_debug() {
    ...
    LoadedMSG="Ps4 Debug 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_historyblock() {
    ...
    LoadedMSG="禁用历史记录已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_updatesdisable() {
    ...
    LoadedMSG="  屏蔽更新已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_updatesenable() {
    ...
    LoadedMSG=" 开启更新已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_dbbackup() {
    ...
    LoadedMSG=" 存档备份 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
...
function load_dbrestore() {
    ...
    LoadedMSG=" 存档恢复 已加载 请等待 左上角跳窗结束再操作";
    let script=document.createElement('script');
